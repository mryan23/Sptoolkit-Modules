...
$module_description = "This is a module for displaying a printable/exportable campaign summary";
//Module Date - This is the date the module was created (yyyy-mm-dd)
$module_date = "2013-09-24";
...
$module_dependencies = array("'Summary','Campaigns'", "'Summary','Education'", "'Summary','Templates'", "'Summary','Targets'");
...
$sql_module = "INSERT INTO `settings_modules` VALUES ('".$module_name."','".$module_path."','".$module_description."','".$module_date."','".$module_core."')";
mysql_query($sql_module) or die(mysql_error());
foreach ($module_dependencies as $mod_dep) {
	$sql_dependencies = "INSERT INTO `settings_modules_dependencies` VALUES (".$mod_dep.")";
